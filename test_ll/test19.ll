...
define dso_local i32 @moo(i8 signext %0, i32 %1, i32 %2) #0 !dbg !53 {
  ...
  br i1 %13, label %14, label %21, !dbg !75
...
21:                                               ; preds = %3
  ...
  %25 = load i32 (i32, i32)*, i32 (i32, i32)** %8, align 8, !dbg !89
  %26 = load i32 (i32, i32)*, i32 (i32, i32)** %7, align 8, !dbg !90
...
28:                                               ; preds = %21, %14
  %29 = load i32 (i32, i32)*, i32 (i32, i32)** %10, align 8, !dbg !92
  %30 = load i32, i32* %5, align 4, !dbg !93
  %31 = load i32, i32* %6, align 4, !dbg !94
  %32 = call i32 %29(i32 %30, i32 %31), !dbg !92
  ret i32 0, !dbg !95
}
...
!1 = !DIFile(filename: "test19.c", directory: "/home/hikonaka/compiler_2021/hw_3/assign3/assign3-test0_29")
!2 = !{}
